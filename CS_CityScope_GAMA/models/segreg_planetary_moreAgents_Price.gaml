...
* Description: 
* Tags: Tag1, Tag2, TagN
* cada punto podrá representar 1,10,20,...,100 agentes. Asegurar que 100*nb_agents > nb_people
...
species building{
	...
	float normalise_rent{
		...
		//rentPriceNorm_gen <- (rentPriceNorm_gen + make_positive)/((make_positive + 1)*precio_doble); //entre 1 y 2 los de Kendall. Para que Somerville etc no estén en negativo
		rentPriceNorm_gen <- (rentPriceNorm_gen + make_positive); //entre 1 y 2 los de Kendall. Para que Somerville etc no estén en negativo
