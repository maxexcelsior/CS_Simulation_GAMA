...
global{
	...
	init{
		...
		ask building{
			save[ID, myCity, usage, scale, category, area, perimeter, rentPriceabs, rentPriceNorm, vacant, diversityNorm, max_height, nbFloors, FAR, type, supported_people, neighbourhood, dorm, luxury, location.x, location.y] type:csv to:"../results/buildings" +".csv" rewrite: false header:true;	
		}
	}
	...
	action save_info{
		save[nb_people, movingPeople,meanDiversityGlobal] type:csv to:"../results/results_gral"+nb_people +".csv" rewrite: false header:true;
		ask people{
			save[cycle, type, living_place.ID, living_place.location.x, living_place.location.y, activity_place.ID, activity_place.location.x, activity_place.location.y, happyUnitSize, actualUnitSize, actualNeighbourhood, actualCity, happyNeighbourhood, mobility_mode_main_activity, time_main_activity, distance_main_activity, CommutingCost, living_place.rentPriceNorm, living_place.dorm, living_place.luxury, agent_per_point] type:csv to:"../results/results_segreg"+nb_people +".csv" rewrite: false header:true;	
		}
	}
