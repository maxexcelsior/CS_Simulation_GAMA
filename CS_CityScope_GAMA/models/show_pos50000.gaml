...
global{
	...
	file resuls <- file("../results/results_segreg50000.csv");
	...
	map<string,rgb> color_per_type <- ["Undergraduate student"::rgb(6,10,147), "Graduate student"::#orange, "PhD"::#red, "Young Professional"::rgb(13,192,156), "Mid-career Professional"::#green, "Executives"::#olive,"Worker"::rgb(186,85,211), "Retiree"::rgb(255,0,255)];
	...
	action import_resuls_50000{
		matrix resuls_matrix <- matrix(resuls);
...
experiment visual type:gui{
	...
	output{
		display map type: opengl fullscreen: 1 draw_env: false background: #black {
